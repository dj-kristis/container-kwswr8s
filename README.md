...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kwswr8s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kwswr8s.containers.anotherwebservice.com/
...
```
git clone git@github.com:dj-kristis/container-kwswr8s.git
cd container-kwswr8s
```
...
```
docker attach container-kwswr8s
```
